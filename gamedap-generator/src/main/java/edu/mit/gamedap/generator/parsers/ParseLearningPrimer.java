 ...
 */
public interface ParseLearningPrimer<T> {
  /**
   ...
   */
  public List<Vector<T>> makeSubstringVectors(String text, int w, Set<Character> characterSet);
   ...
   */
  public List<VectorCluster<T>> assignVectorClusters(List<Vector<T>> inputVectors, Set<Character> characterSet);
}
